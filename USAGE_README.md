...
kubectl get pods | grep idea-hub-mcp
```
...
# Kubernetes logs
kubectl logs deployment/idea-hub-mcp-server
```
...
- **Deployment Documentation:** See deployment guides in `/docs`
- **Configuration Guide:** See environment setup documentation
